...
public class KWLinkedList<E> extends AbstractSequentialList<E> {
    ...
    public void removeAll(String target) {
        ListIterator<E> iterator = this.listIterator();
        while(iterator.hasPrevious()) {
            E node = iterator.previous();
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        KWLinkedList<String> kwLinkedList = new KWLinkedList<>();
        kwLinkedList.add("Tom");
        kwLinkedList.add("Dick");
        kwLinkedList.add("Harry");
        kwLinkedList.add("Sam");
        kwLinkedList.add("Dick");
        System.out.println(kwLinkedList.toString());

        kwLinkedList.removeAll("Dick");
        System.out.println(kwLinkedList.toString());
